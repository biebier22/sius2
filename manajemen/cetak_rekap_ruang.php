...
<table class="info-header" width="100%" border="0">
<tr>
    <td width="20%"><strong>UPBJJ-UT</strong></td>
    <td width="2%">:</td>
    <td width="28%"><strong>SERANG</strong></td> <td width="20%"><strong>MASA UJIAN</strong></td>
    <td width="2%">:</td>
    <td><strong><?php echo $masa_reg ?></strong></td>
</tr>

<tr>
    <td><strong>TEMPAT UJIAN</strong></td>
    <td>:</td>
    <td><strong><?php echo htmlspecialchars($pos_ujian); ?></strong></td>
    <td><strong>HARI</strong></td>
    <td>:</td>
    <td><strong><?php echo htmlspecialchars($hari2); ?></strong></td>
</tr>

<tr>
    <td><strong>LOKASI UJIAN</strong></td>
    <td>:</td>
    <td><strong><?php echo htmlspecialchars($lokasi); ?></strong></td>
    <td><strong>TANGGAL</strong></td>
    <td>:</td>
    <td><strong><?php echo date('d F Y', strtotime($tgl_ujian)); ?></strong></td>
</tr>
</table>
